    ...
    <div className="grid grid-cols-1 lg:grid-cols-[1fr_3fr] gap-12">
      ...
      <Card color="white" className="grid grid-cols-1 sm:grid-cols-3 gap-y-6 p-8 text-center">
        <div className="border-solid border-[var(--grey-light)] pb-6 sm:pb-0 border-b-[0.1rem] sm:border-r-[0.1rem] sm:border-b-0">
          ...
          <p className="font-bold text-[2.6rem] leading-[3.5rem] mt-3 mb-5">{data.juniorSalary}</p>
        ...
        <div className="border-solid border-[var(--grey-light)] pb-6 sm:pb-0 border-b-[0.1rem] sm:border-r-[0.1rem] sm:border-b-0">
          ...
          <p className="font-bold text-[2.6rem] leading-[3.5rem] mt-3 mb-5">{data.middleSalary}</p>
          <div className="grid grid-cols-[2rem_2rem_2rem] justify-center gap-x-4">
            <HhStarIcon className="filled" />
            <HhStarIcon className="filled" />
            <HhStarIcon />
        ...
        <div>
          ...
          <p className="font-bold text-[2.6rem] leading-[3.5rem] mt-3 mb-5">{data.seniorSalary}</p>
          <div className="grid grid-cols-[2rem_2rem_2rem] justify-center gap-x-4">
            <HhStarIcon className="filled" />
            <HhStarIcon className="filled" />
            <HhStarIcon className="filled" />
